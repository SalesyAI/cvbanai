...
import { Mail, Lock, User, ArrowRight, AlertCircle, Eye, EyeOff, Sparkles, CheckCircle, RefreshCw } from 'lucide-react'
                        ...
                        {awaitingVerification ? (
                            <div className="text-center">
                                ...
                                <p className="text-text-light-secondary dark:text-gray-400 mb-6">
                                    We've sent a verification link to <strong className="text-text-light-primary dark:text-white">{email}</strong>
                                </p>

                                {/* Success/Error Messages */}
                                {success && (
                                    <div className="flex items-center gap-3 p-4 bg-green-50 dark:bg-green-500/10 border border-green-200 dark:border-green-500/30 rounded-xl text-green-600 dark:text-green-400 mb-4">
                                ...
                                {error && (
                                    <div className="flex items-center gap-3 p-4 bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-xl text-red-600 dark:text-red-400 mb-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 text-text-light-secondary dark:text-gray-400 hover:text-primary-500 font-medium transition-colors"
                                    >
